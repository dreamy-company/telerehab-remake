    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
        ...
        <div
            ...
            <div class="flex items-center gap-3 w-full sm:w-auto">
                <div class="w-10 h-10 rounded-lg bg-teal-100 flex items-center justify-center text-teal-600 shadow-sm">
                    <i class="fas fa-layer-group"></i>
                </div>
                <div>
                    <h2 class="text-lg font-bold text-slate-800 leading-tight">Rehabilitation Phases</h2>
                    <p class="text-xs text-slate-500">Manage therapy stages and milestones.</p>
                </div>
            </div>
            ...
            <div class="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
                ...
                <a href="{{ route('admin.rehabilitation-phase.create') }}"
            ...
            <table class="min-w-full divide-y divide-slate-200">
                <thead class="bg-slate-50">
                    <tr>
                        ...
                        <th scope="col"
                            class="px-6 py-4 text-left text-xs font-bold text-slate-500 uppercase tracking-wider">Phase
                            Name
                        </th>
                        <th scope="col"
                        ...
                        <tr class="hover:bg-slate-50/80 transition-colors group">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center gap-3">
                                    <span
                                        class="w-8 h-8 rounded-full bg-slate-100 text-slate-500 flex items-center justify-center text-xs font-bold border border-slate-200">
                                        {{ $index + 1 }}
                                    </span>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex items-center justify-end gap-2">
                                    <a href="{{ route('admin.rehabilitation-phase.edit', $item->id) }}"
                                    ...
                                    <button wire:click="delete({{ $item->id }})"
                                        ...
                                        onclick="return confirm('Are you sure you want to delete this phase?') || event.stopImmediatePropagation()"
                                        data-tip="Delete">
                        ...
                        <tr>
                            <td colspan="3" class="px-6 py-16 text-center">
                                <div class="flex flex-col items-center justify-center text-slate-400">
                                    ...
                                    <h3 class="text-slate-900 font-bold text-lg">No Phases Found</h3>
                                    <p class="text-sm mt-1">Start by adding a new rehabilitation phase.</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
        ...
        <div
            ...
            <span>Total {{ count($data) }} Phases</span>
        </div>
    </div>
</div>