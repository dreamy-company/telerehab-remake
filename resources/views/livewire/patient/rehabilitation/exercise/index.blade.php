    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        <div id="uploadZone" class="bg-white shadow-lg rounded-xl p-8 border border-gray-100 flex flex-col h-full">
            ...
            <div class="space-y-4 mb-8">
                <div class="grid grid-cols-2 gap-3">
                    <div class="bg-slate-50 p-3 rounded-lg border border-slate-100">
                        ...
                        <span
                            class="text-sm font-semibold text-gray-700">{{ $rehabData->rehabilitation->rehabRoutines->first()->goal }}</span>
                    </div>
                    <div class="bg-slate-50 p-3 rounded-lg border border-slate-100">
                        <span class="text-[10px] font-bold text-gray-400 uppercase block mb-1">Target</span>
                        <span
                            class="text-sm font-semibold text-gray-700">{{ \Carbon\Carbon::parse($rehabData->rehabilitation->rehabRoutines->first()->target)->format('d M Y') }}</span>
                    </div>
                </div>
            ...
            <div class="mt-auto pt-6 border-t border-dashed border-gray-200">
                ...
                <button onclick="uploadModal.showModal()"
                    class="w-full bg-teal-600 hover:bg-teal-700 text-white font-bold py-3.5 px-4 rounded-xl transition duration-200 flex items-center justify-center gap-3 shadow-md hover:shadow-lg active:scale-[0.98]">
